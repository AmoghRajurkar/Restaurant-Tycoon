...
public class KeyHandler implements KeyListener {
    ...
    /**
     * Handles key press events by updating the corresponding boolean flags for movement, interaction, toggling UI elements, and other actions.
     *  It checks the key code of the pressed key and sets the appropriate flags to true, which can then be used in the game logic to determine the player's actions. 
     * The method also captures digit keys for typing quantities in the restock panel.
    ...
    /**
     * Handles key release events by updating the corresponding boolean flags to false.
