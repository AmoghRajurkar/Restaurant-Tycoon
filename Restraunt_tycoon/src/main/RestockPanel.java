...
public class RestockPanel {
    ...
    /**
     * Constructor for the RestockPanel class.
     * @param inventory The inventory instance to manage restocking.
     */
     ...
     * @param dir The direction to move the selection (1 for down, -1 for up)
     */
    ...
    /**
     * Activates typing mode for the currently selected item, allowing the player to input a quantity to restock. 
     * It clears any previously typed quantity and sets the typingMode flag to true.
     */
    ...
    /**
     * Draws the restock panel on the screen if it is visible. It renders a semi-transparent background with a border, 
     * displays the list of buyable items with their quantities, and shows an input box for typing the quantity to restock.
