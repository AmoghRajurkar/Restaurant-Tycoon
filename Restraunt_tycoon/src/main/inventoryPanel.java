...
public class inventoryPanel {
    ...
    /**
     * Constructor for the inventoryPanel class, which initializes the inventory reference. This allows the panel to access the player's inventory data, such as item quantities and money, 
     * to display it on the screen.
     * @param inventory The Inventory instance that this panel will display, providing access to the player's items and money for rendering the inventory UI.
     */
    ...
    /**
     * Moves the selection up or down in the inventory list based on the input direction. It updates the selectedIndex to
     * reflect the new selection and adjusts the scrollOffset to ensure that the selected item remains visible within the panel. 
     * @param dir The direction to move the selection (negative for up, positive for down)
     */
    ...
    /**
     * Draws the inventory panel on the screen if it is visible. It renders a semi-transparent background with a border, displays the title "Inventory",
     *  and lists the player's items and their quantities.
