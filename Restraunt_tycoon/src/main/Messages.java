...
public class Messages {
    ...
    /**
     * Constructor for the Messages class, which initializes the message string. This allows the class to store the message that will be displayed on the screen when showMessage is called.
     * @param Message The message string to be displayed, which can be set when creating an instance of the Messages class and used later for rendering messages to the player.
     */
    ...
    /**
     * Displays a message on the screen for a specified duration. It sets the message to be displayed, makes it visible, 
     * and records the start time to determine when to hide the message after the duration has passed.
     * @param msg The message string to be displayed for the specified duration.
     */
    @SuppressWarnings("static-access")
    ...
    /**
     * Draws the message on the screen if it is visible. It renders a semi-transparent background with a border, and displays the message text centered within the panel.
